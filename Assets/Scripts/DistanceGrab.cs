...
public class DistanceGrab : MonoBehaviour
{
    ...
    void UpdateGrabbedObject()
    {
        ...
        float moveAmount = 3f * Time.deltaTime;
        isObjectClose |= Vector3.Distance(toBePosition, grabbedObject.transform.position) <= 0.1f;
    ...
    void Update()
    {
        ...
        else if (OVRInput.Get(OVRInput.RawButton.A) && hitObject != null) {
